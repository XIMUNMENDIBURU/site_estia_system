            ...
            <?php if($_SESSION['LOGGED_USER']) : ?>
                ...
                <form id="form-event" action="upload.php" method="post" enctype="multipart/form-data">
                    ...
                    <p id="pParagraphe">
                        ...
                        <textarea name="paragraphe" id="paragraphe"></textarea>
                    </p>
                    <p id="pImage">
                        <label for="image">Image à télécharger (2Mo max):</label>
                        <input type="file" name="image" id="image" accept="image/*" onChange="previewImage(this);">
                        <img id="preview" src="#" alt="Aperçu de l'image" style="display:none; width:100px;">                  
                    </p>
                    <p>
                        <input id="bouton" value="Enregistrer" name="form_submit" type="submit">
                    </p>
                </form>
            <?php endif ?>
        </div>
